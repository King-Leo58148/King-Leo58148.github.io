export default function Sidebar({ hero, contact }) {
  return (
    <aside className="sidebar">
      <div className="sidebar-inner">
        <div className="sidebar-top">
          ...
          <nav className="nav">
            <ul>
              <li><a href="#about" className="nav-link"><span className="line"></span>About</a></li>
              <li><a href="#experience" className="nav-link"><span className="line"></span>Experience</a></li>
              <li><a href="#projects" className="nav-link"><span className="line"></span>Projects</a></li>
              <li><a href="#contact" className="nav-link"><span className="line"></span>Contact</a></li>
            </ul>
          </nav>
        </div>
        <div className="sidebar-socials">
          {contact?.github && (
            <a href={contact.github} target="_blank" rel="noopener" aria-label="GitHub">
